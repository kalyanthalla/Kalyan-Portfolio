...
function Contact({ isDarkMode }) {
  ...
  return (
    <section 
      id="contact" 
      className={`w-full px-4 sm:px-6 lg:px-8 py-12 md:py-16 max-h-screen flex items-center scroll-mt-20 transition-colors duration-300 relative overflow-hidden ${
        ...
        <div className={`flex flex-col lg:flex-row rounded-xl overflow-hidden ${
          ...
          <div className="lg:w-2/5 p-6 sm:p-8 lg:p-10 flex flex-col justify-center">
            ...
            <div className="space-y-3 sm:space-y-3">
              <div className="flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" className={`h-5 w-5 sm:h-5 sm:w-5 mr-3 sm:mr-3 ${
                  isDarkMode ? 'text-purple-400' : 'text-purple-600'
                }`} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path>
                  <polyline points="22,6 12,13 2,6"></polyline>
                </svg>
                <span className={`text-sm sm:text-sm poppins ${
                  isDarkMode ? 'text-gray-300' : 'text-gray-600'
          ...
          <div className="lg:w-3/5 p-6 sm:p-8 lg:p-10">
            <form onSubmit={onSubmit}>
              <div className='grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-4 mb-5 sm:mb-5'>
                <div>
                  <label className={`block text-sm sm:text-sm poppins font-medium mb-2 ${
              ...
              {result && (
                <p className={`mb-4 sm:mb-4 text-center text-sm sm:text-sm ${
              ...
              <div className="text-center">
                <button 
                  ...
                  className={`px-8 sm:px-8 py-3.5 sm:py-3 rounded-full text-sm sm:text-base font-medium poppins transition-all duration-300 flex items-center gap-2 sm:gap-2 mx-auto ${
                    isDarkMode 
                ...
                >
                  {isSubmitting ? (
                    <>
                      <svg className="animate-spin -ml-1 mr-1 sm:mr-2 h-4 w-4 sm:h-4 sm:w-4 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                    ...
                    <>
                      Send Message
                      <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" className="w-4 h-4 sm:w-4 sm:h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
