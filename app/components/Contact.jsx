            ...
            <form onSubmit={onSubmit}>
              <div className='grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-5 mb-5'>
                <div>
                  ...
                  <input 
                    ...
                    type='text'
                    required 
                    className={`w-full px-4 py-2.5 sm:px-4 sm:py-3 text-sm sm:text-base outline-none border rounded-lg transition-all hover:scale-[1.01] focus:scale-[1.01] ${
                      isDarkMode 
              ...
              <div className='mb-5'>
                ...
                <textarea
                  id="message"
                  rows='4'
                  className={`w-full px-4 py-3 text-sm sm:text-base outline-none border rounded-lg transition-all resize-none hover:scale-[1.01] focus:scale-[1.01] ${
                    isDarkMode
                      ? 'bg-gray-700/50 border-gray-600 text-white focus:border-purple-500 hover:border-purple-500'
                      : 'bg-white border-gray-300 text-gray-800 focus:border-purple-500 hover:border-purple-500'
                  }`}
              ...
              <div className="text-center">
                <button 
                  ...
                  className={`px-8 py-3 sm:px-10 sm:py-3.5 rounded-full text-sm sm:text-base font-medium transition-all duration-300 flex items-center justify-center gap-2 mx-auto ${
                    isDarkMode 
                      ? 'bg-purple-600 hover:bg-purple-500 text-white shadow-lg hover:shadow-purple-500/30 hover:scale-105 active:scale-98' 
                      : 'bg-purple-600 hover:bg-purple-700 text-white shadow-lg hover:shadow-purple-600/30 hover:scale-105 active:scale-98'
